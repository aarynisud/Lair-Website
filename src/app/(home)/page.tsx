...
const fetchShards = async () => {
    const response = await fetch(`https://api.lair.rocks/status`)
    if (!response.ok) {
        ...
        <>
            ...
            <div className="flex flex-col h-screen w-screen items-center justify-center">
                <motion.div
                    ...
                    <Image src={lair} alt="lair" width={300} height={300} />
                </motion.div>
                <motion.h1
                    initial="hidden"
                    animate="visible"
