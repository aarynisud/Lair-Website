const Terms = () => {
    return (
        <div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
            ...
            <span className="text-lair-main italic text-sm mt-5">
                Last updated And Effective Since: 2024-01-01
            </span>
            <span className="text-neutral-400 text-sm mt-5 pb-5">
                By visiting (&apos;lair&apos;) or inviting (&apos;lair Bot&apos;) to your Discord or
                logging into our website (&apos;lair.rocks&apos;), you agree and consent to the terms
                displayed on this page including our policies (Privacy Policy). When we state
                &apos;lair&apos;, &apos;we&apos;, &apos;us&apos;, and &apos;our&apos; in these
                terms, we mean lair. &apos;Services&apos; mean lair&apos;s services that we offer to
                users.
            </span>
            <span className="text-neutral-400 text-sm mt-5">
                If any information stated here seems misleading, please contact us @{" "}
                <span className="text-white font-semibold">support@lair.rocks</span>
            </span>
            <span className="font-bold text-2xl text-white pt-10">Disclaimer</span>
            <span className="text-neutral-400 text-sm mt-5">
                You may not use lair to violate any applicable laws or regulations as well as
                ...
                <span className="text-white font-semibold">support@lair.rocks</span>. If you are
                refunded under any circumstances, your Discord account may be subject to blacklist
                and a ban from all of our services.
            </span>
            <span className="font-bold text-2xl text-white pt-10">lair Website Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                <li className="text-neutral-400 marker:text-lair-main">
                ...
                <li className="text-neutral-400 marker:text-lair-main">
                    Copy lair&apos;s website and claiming it as your own work
                </li>
            </div>
            <span className="font-bold text-2xl text-white pt-10">lair Bot Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-lair-main">
                    Copy lair&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-lair-main">
                    Assist anyone in copying lair&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-lair-main">
                    Abuse or exploit lair or any of our services.
                </li>
                <li className="text-neutral-400 marker:text-lair-main">
